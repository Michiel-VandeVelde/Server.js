...
//
// (nyc's "all": true config option was considered as an alternative — it makes nyc report
// real, if 0%, coverage for every file it CAN see — but it doesn't help when zero .ts files
// exist yet (nothing to instrument either way), and separately broke ambient-module type
// resolution for ts-node during its own pre-instrumentation walk. Not used here.)
const fs = require('fs');
