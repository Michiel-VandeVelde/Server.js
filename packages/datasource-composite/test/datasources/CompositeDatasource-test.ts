...
describe('CompositeDatasource', () => {
  ...
  describe('A CompositeDatasource with datasources in different graphs', () => {
    ...
    it('should skip a non-matching datasource when choosing where to start', () => new Promise<void>((done) => {
    ...
    it('should stop instead of continuing into a non-matching datasource', () => new Promise<void>((done) => {
