...
class Datasource extends EventEmitter {
  ...
  constructor(options?: any, supportedFeatureList?: any) {
    super();
    ...
    if (supportedFeatureList && supportedFeatureList.length) {
      let objectSupportedFeatures: any = {};
  ...
  select(query: any, onError?: any) {
    ...
    outputQuads = destination.map((quad: any) => {
  ...
  _executeQuery(query: any, destination: any) {
