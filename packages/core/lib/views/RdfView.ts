...
class RdfView extends View {
  ...
  _generateRdf(settings: any, data: any, metadata: any, done: any) {
    throw new Error('The _generateRdf method is not yet implemented.');
  }

  // Renders the specified view extension
  override _renderViewExtension(extension: any, options: any, request: any, response: any, done: any) {
  ...
  _addDatasources(settings: any, data: any, metadata: any) {
  ...
  _createJsonLdWriter(settings: any, response: any, done: any) {
