...
function mockModulePreservingThis<T extends object>(actual: T, overrides: Partial<T>): T {
...
vi.mock('child_process', async (importOriginal) => {
  ...
  return mockModulePreservingThis(actual, { spawn: vi.fn(actual.spawn) as unknown as typeof actual.spawn });
});
...
describe('ExternalHdtDatasource', () => {
  describe('The ExternalHdtDatasource module', () => {
    ...
    it('should be an ExternalHdtDatasource constructor', () => new Promise<void>((done) => {
  ...
  describe('created for a non-existing file', () => {
    it('should fail to initialize', () => new Promise<void>((done) => {
  ...
  describe('A ExternalHdtDatasource instance for an example HDT file', () => {
    let datasource: ExternalHdtDatasource;
